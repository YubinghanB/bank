...
const file_service_simple_bank_proto_rawDesc = "" +
	...
	"Login user\x1a\x1aUse this API to login user\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_user\x12\x87\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"J\x92A-\x12\vUpdate user\x1a\x1eUse this API to update a  user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_userBp\x92A^\x12\\\n" +
	"\x0fSimple Bank API\"D\n" +
	"\tEthan Bai\x12\x1fhttps://github.com/Yubinghanbai\x1a\x16baiyubinghan@gmail.com2\x031.2Z\rsimplebank/pbb\x06proto3"
